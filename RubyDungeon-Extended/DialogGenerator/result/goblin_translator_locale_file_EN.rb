,
        ...
        LocaleKey::DIAL_GOBLIN_TRANSLATOR_TXT_GRAMMAR => [
            "A talk of goblins order differenctly then a talk of humans.\nWhile humans say a subject first, followed by a action and a object, goblins say a action first, followed by a subject and a object.",
            "A subject and a object are both prefixed by a article. Either « Sö » for a singular object, « Kö » when multiple and « Tö » for when talking about a totality of a group",
            "So, a example be « Some humans know a talk of goblin » in your langage, being « Know some human a talk goblin ».\nWhich when translating all the words give « Kosäpor kö tarkorbakö sö pöko köpoduk ».",
            ...
            "Also, sometimes in a sentence a subject can be missing, or even a subject and a object.\nIf a subject is missing we will assume the subject to be « You », and if both a subject and a object is missing we also assume a object is « me »",
        ...
        LocaleKey::DIAL_GOBLIN_TRANSLATOR_KEY_KNOW_ENGLISH => ["you|know|learn|humans|english|talk|speak|well|good|great"],
        ...
        LocaleKey::DIAL_GOBLIN_TRANSLATOR_TXT_KO_RAKROT => [
            "Kö Rakröt bëdès is named after the fact Kö Rakröt Bëdès is usually a goblin that handle warding off adventurers approaching our village",
        ],
