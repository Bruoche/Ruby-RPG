class FR
    TEXTS = {
        ...
        LocaleKey::GOLEM_RIGHT_LEG_CRYSTAL => "formation cristaline sur la jambe droite du golem",
        LocaleKey::GOLEM_LEFT_LEG_CRYSTAL => "formation cristaline sur la jambe gauche du golem",
        LocaleKey::GOLEM_HEAD => "tête du golem",
        LocaleKey::GOLEM_LEFT_ARM => "bras gauche du golem",
