class FR
    TEXTS = {
        ...
        LocaleKey::H30_PLASTRON_DESC => "une robe à manche longue en maille déscendant jusqu'au genout recouvert d'un fin surcôt, protégeant tout le corps contre d'éventuelles attaques.",
        ...
        LocaleKey::H40_PLASTRON_DESC => "une cuirasse particulièrement large protégeant l'entièreté du corps avec des épaulières et une cotte de maille longue pour le haut des jambes.",
        ...
        LocaleKey::H50_PLASTRON_DESC => "une cuirasse complète large protégeant l'entièreté du torse, laissant uniquement l'entre-jambe découvert pour faciliter l'équitation. En plus de ces épaulières larges, cette armure possède un très large renforcement couvrant l'entièreté du côté droit, ressemblant à une sorte de cape d'épaule métalique. Prévu pour supporter les plus lourdes frappes à la lance.",
        ...
        LocaleKey::M30_PLASTRON_DESC => "une robe de maille à manche longue simple protégeant l'entièreté du corps jusqu'au genou, tenue par une simple ceinture. Offrant une protéction décente à bas prix.",
        ...
        LocaleKey::M40_PLASTRON_NAME => "robe de maille modeste",
        LocaleKey::M40_PLASTRON_DESC => "une robe de maille à manche longue simple protégeant l'entièreté du corps, couvertes par un surcôt neutre.",
