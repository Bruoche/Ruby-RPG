class EN
    TEXTS = {
        ...
        LocaleKey::HEALTH_STONE_USE_SELF => "%s use a life stone...",
        LocaleKey::HEALTH_STONE_USE_OTHER => "%{#{LocaleKey::F_SOURCE}} use a life stone on %{#{LocaleKey::F_TARGET}}...",
        ...
        LocaleKey::HEALTH_STONE_NAME => "a healing stone",
