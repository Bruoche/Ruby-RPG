class EquipmentSlot
    ...
    def get_card(index = ASCIIPicture::NO_INDEX)
        if @equippedArmor == NO_ARMOR_EQUIPPED
            ...
            text = TextFormatter.multiline(TextFormatter.center(format(Locale.get_localized(LocaleKey::NO_ARMOR_EQUIPPED), Locale.get_localized(@type::NAME)), ASCIIPicture::ITEM_ICON_WIDTH), ASCIIPicture::ITEM_ICON_WIDTH)
